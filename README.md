...
* O que aprendi e sei fazer:
    * Aprendi a usar if/else com operadores ternários, e a analizar o código e fazer as devidas mudanças para que ele fique o mais legível possível para terceiros.
